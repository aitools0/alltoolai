        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="mt-4 space-y-2 list-disc pl-5 text-slate-800 text-lg font-semibold dark:text-slate-300">
                    ...
                    <li><a href="/text-tools" class="text-indigo-600 dark:text-indigo-400 font-bold hover:text-purple-600 dark:hover:text-purple-400">Text Tools</a></li>
            ...
            <div>
                ...
                <ul class="mt-4 space-y-2 list-disc pl-5 text-slate-800 text-lg font-semibold dark:text-slate-300">
                    ...
                    <li><a href="/html-to-text" class="color-link2 hover:text-purple-600 dark:hover:text-purple-400">Html to Text</a></li>
                    <li><a href="/text-to-code" class="color-link3 hover:text-purple-600 dark:hover:text-purple-400">Text to Code & Code to Text</a></li>
                    <li><a href="/text-analyzer" class="color-link4 hover:text-purple-600 dark:hover:text-purple-400">Text Analyzer</a></li>
                    <li><a href="/text-formatter" class="color-link5 hover:text-purple-600 dark:hover:text-purple-400">Text Formatter</a></li>
                </ul>
            </div>
        </div>
