    ...
    <div class="max-w-screen-xl mx-auto">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="mt-4 space-y-2 list-disc pl-5 text-slate-800 text-lg font-semibold dark:text-slate-300">
                    <li><a href="https://www.alltoolai.com/image-tools" class="text-indigo-600 dark:text-indigo-400 font-bold hover:text-purple-600 dark:hover:text-purple-400">Image Tools</a></li>
            ...
            <!-- Tools -->
            <div>
                <h2 class="text-indigo-600 dark:text-indigo-400 text-xl font-bold underline mb-4 underline-offset-8">Image Tools</h2>
                <ul class="mt-4 space-y-2 list-disc pl-5 text-slate-800 text-lg font-semibold dark:text-slate-300">
                    <li><a href="https://www.alltoolai.com/image-crop" class="color-link1 hover:text-purple-600 dark:hover:text-purple-400">Image Cropper</a></li>
                    <li><a href="https://www.alltoolai.com/image-resize" class="color-link2 hover:text-purple-600 dark:hover:text-purple-400">Image Resize</a></li>
                    <li><a href="https://www.alltoolai.com/images-compress" class="color-link3 hover:text-purple-600 dark:hover:text-purple-400">Images Compressor</a></li>
                    <li><a href="https://www.alltoolai.com/images-convert" class="color-link4 hover:text-purple-600 dark:hover:text-purple-400">Images Converter</a></li>
                    <li><a href="https://www.alltoolai.com/image-rotate-flip" class="color-link5 hover:text-purple-600 dark:hover:text-purple-400">Image Rotate & Flip</a></li>
                    <li><a href="https://www.alltoolai.com/image-to-base64" class="color-link6 hover:text-purple-600 dark:hover:text-purple-400">Image to Base64</a></li>
                    <li><a href="https://www.alltoolai.com/base64-to-image" class="color-link7 hover:text-purple-600 dark:hover:text-purple-400">Base64 to Image</a></li>
                </ul>
            </div>
        </div>
